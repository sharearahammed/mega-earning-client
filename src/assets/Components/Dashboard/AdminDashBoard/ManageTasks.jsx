...
const ManageTasks = () => {
    ...
    return (
        <div className='pt-[120px] pb-6 p-5 lg:pl-14 md:pl-14 min-h-screen rounded-none bg-no-repeat bg-cover overflow-x-auto w-full flex flex-col text-gray-800 bg-gray-50' style={{
          backgroundImage:
